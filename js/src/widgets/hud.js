(function($) {
  ...
  $.Hud.prototype = {
    ...
    template: Handlebars.compile([
                                 ...
                                 '</a>',
                                 '<a class="mirador-osd-rotate-ccw hud-control" role="button" aria-label="Rotate counter-clockwise">',
                                 '<i class="fa fa-rotate-left"></i>',
                                 '</a>',
                                 '<a class="mirador-osd-rotate-cw hud-control" role="button" aria-label="Rotate clockwise">',
